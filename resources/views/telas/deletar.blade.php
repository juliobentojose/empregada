  <div class="modal fade" id="deletarpedido{{$item->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog ">
        <div class="modal-content ">
            <div class="modal-header btn-danger" >
                <h4 style=" color: rgb(250, 247, 247);">Apagar Pedido</h4>
            ...
            <div class="modal-body" style="background-color:rgb(206, 210, 211);">
               <form action="{{route('pedido.destroy', $item->id)}} " method="POST">
                 @csrf
                 @method('DELETE')
                   <h4>Desejas apagar este pedido?</h4>
